...
export function generateSigstoreWorkflow(primaryLanguage = ""): string {
  if (primaryLanguage === "python") return generatePythonSigstore();
  return generateGenericSigstore();
}

function generatePythonSigstore(): string {
...
function generateGenericSigstore(): string {
