...
export function generateSecurityMd(repoName = "this project", contactEmail = ""): string {
  const emailSection = contactEmail
...
The ${repoName} team takes security vulnerabilities seriously. We appreciate
...
${emailSection}
- **GitHub Security Advisories**: Use [GitHub's private vulnerability reporting](https://github.com/OWNER/${repoName}/security/advisories/new) to report a vulnerability directly.
...
- [GitHub Security Advisories](https://github.com/OWNER/${repoName}/security/advisories)
- Release notes
...
We gratefully acknowledge security researchers who help keep ${repoName} safe.
