...
1. **Fork** the repository and clone your fork:
   ```bash
   git clone https://github.com/<your-username>/ossguard-npm.git
   cd ossguard-npm
   ```
...
2. Make your changes, ensuring:
   ...
   - Public functions include JSDoc comments
...
1. Create `src/analyzers/<name>.ts` with:
   - TypeScript interfaces for the report (e.g., `MyReport`)
   - A public function (e.g., `checkMyThing(projectPath: string)`)
...
- Use [GitHub Issues](https://github.com/kirankotari/ossguard-npm/issues)
